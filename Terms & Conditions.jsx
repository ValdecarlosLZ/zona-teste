...
export default function LongContentDemo() {
    ...
    const footerContent = (
        <div>
            <Button label="Não li e não aceito" icon="pi pi-times" onClick={() => setVisible(false)} className="p-button-text" />
            <Button label="Li e aceito" icon="pi pi-check" onClick={() => setVisible(false)} autoFocus />
        </div>
    );

    return (
        <div className="card flex justify-content-center">
            <Button label="Terms & Conditions" onClick={() => setVisible(true)} />
            <Dialog header="Terms & Conditions" visible={visible} style={{ width: '50vw' }} onHide={() => setVisible(false)} footer={footerContent}>
                <p className="mb-5">
